""" Gets current NiceHash mining statistics, writes to InfluxDB """
...
if __name__ == "__main__":
    ...
    while True:
        ...
        usdrate = requests.get("https://api2.nicehash.com/exchange/api/v2/info/prices").json()["BTCUSDC"]

        raw = requests.get("https://api2.nicehash.com/main/api/v2/mining/external/3M6uRT9JF7VeSKQqtwzSUJZfgVWGW4xvw2/rigs2").json()
        rigs = raw["miningRigs"]
